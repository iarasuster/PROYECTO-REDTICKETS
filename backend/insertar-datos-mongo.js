...
const contenido = [
  ...
  },
  {
    ...
    fundadores: [
      ...
      { id: generateId(), nombre: 'Carlos Fleurquin', cargo: 'Licenciado en Administración y emprendedor' },
    ...
    equipo: [
      { id: generateId(), nombre: 'Dani', area: 'Desarrollo', detalle: 'Sabe hacer buen pancito, dudamos que sepa algo más.' },
      { id: generateId(), nombre: 'Fabri', area: 'Programación', detalle: 'Todos quieren algo de él, pobrecito.' },
      { id: generateId(), nombre: 'Rochi', area: 'Comercial', detalle: 'Nuestra astróloga de cabecera.' },
      { id: generateId(), nombre: 'Sofi', area: 'Comercial', detalle: 'La más antigua del equipo, la más compañera.' },
      { id: generateId(), nombre: 'Fran', area: 'Comercial', detalle: 'El más charlatán, pero también el que tira más para adelante.' },
      { id: generateId(), nombre: 'Emi', area: 'Desarrollo', detalle: '' },
      { id: generateId(), nombre: 'Cami', area: 'Marketing', detalle: '' },
      { id: generateId(), nombre: 'Marchu', area: 'Administración', detalle: 'Vive lejitos pero siempre la tenemos cerca.' },
  ...
  },
  {
    ...
    equipo: [],
    servicios_lista: [
      { id: generateId(), servicio: 'Venta y gestión de entradas: crear, vender, controlar y liquidar.' },
      { id: generateId(), servicio: 'Compra de entradas: múltiples medios de pago, tanto locales como internacionales.' },
      { id: generateId(), servicio: 'APP RedTickets: permite comprar tickets, acceder a la billetera y recibir notificaciones.' },
      ...
      { id: generateId(), servicio: 'Control de acceso: personal capacitado, software propio y aplicación ControlTickets.' },
      { id: generateId(), servicio: 'Configuración avanzada: descuentos, promociones, códigos de acceso y límites de compra.' },
      ...
      { id: generateId(), servicio: 'Sistema propio de acreditaciones: etiquetas personalizadas y credenciales.' }
    ],
    testimonios: [],
    como_comprar: { introduccion: '', pasos: [] },
    recepcion_tickets: { descripcion: '', instrucciones: [] },
