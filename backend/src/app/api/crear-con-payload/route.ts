  ...
  try {
    ...
    await payload.create({
      ...
      data: {
        ...
        equipo: [
          { nombre: 'Dani', area: 'Desarrollo', detalle: 'Sabe hacer buen pancito' },
          { nombre: 'Fabri', area: 'Programación', detalle: 'Todos quieren algo de él' },
          { nombre: 'Rochi', area: 'Comercial', detalle: 'Nuestra astróloga' },
          { nombre: 'Sofi', area: 'Comercial', detalle: 'La más antigua del equipo' },
          { nombre: 'Fran', area: 'Comercial', detalle: 'El más charlatán' },
          { nombre: 'Emi', area: 'Desarrollo', detalle: '' },
          { nombre: 'Cami', area: 'Marketing', detalle: '' },
          { nombre: 'Marchu', area: 'Administración', detalle: 'Vive lejitos' },
