  ...
  try {
    ...
    const contenidoCompleto = {
      ...
      sobre_nosotros: {
        ...
        equipo: [
          { nombre: "Dani", area: "Desarrollo", detalle: "Sabe hacer buen pancito, dudamos que sepa algo más." },
          { nombre: "Fabri", area: "Programación", detalle: "Todos quieren algo de él, pobrecito." },
          { nombre: "Rochi", area: "Comercial", detalle: "Nuestra astróloga de cabecera." },
          { nombre: "Sofi", area: "Comercial", detalle: "La más antigua del equipo, la más compañera." },
          { nombre: "Fran", area: "Comercial", detalle: "El más charlatán, pero también el que tira más para adelante." },
          { nombre: "Emi", area: "Desarrollo", detalle: "" },
          { nombre: "Cami", area: "Marketing", detalle: "" },
          { nombre: "Marchu", area: "Administración", detalle: "Vive lejitos pero siempre la tenemos cerca." },
          { nombre: "Vale", area: "Comercial", detalle: "" },
          { nombre: "Fede", area: "Atención al cliente", detalle: "" },
